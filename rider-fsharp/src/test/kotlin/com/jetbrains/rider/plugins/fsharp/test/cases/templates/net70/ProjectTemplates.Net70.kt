...
object Net70 {
  ...
  class ConsoleAppProjectTemplateTest : ConsoleAppProjectTemplateTestBase() {
    ...
    override val buildFilesIgnoreList: Set<Regex> = setOf(
      ...
      Regex("ConsoleApplication/obj/Debug/net7\\.0/ConsoleApplication\\.(fsproj\\.CopyComplete|runtimeconfig\\.json|\\.deps.json)"),
  ...
  class XUnitProjectTemplateTest : XUnitProjectTemplateTestBase() {
    ...
    override val buildFilesIgnoreList: Set<Regex> = setOf(
      ...
      Regex("UnitTestProject/obj/Debug/net7\\.0/UnitTestProject\\.(fsproj\\.CopyComplete|runtimeconfig\\.json|\\.deps.json)")
    )
    init {
